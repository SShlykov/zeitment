...
import (
	...
	bookeventsrepo "github.com/SShlykov/zeitment/bookback/internal/domain/services/bookevents"
...
func SetBookEventController(e *echo.Echo, database postgres.Client, metrics metrics.Metrics, logger *slog.Logger, ctx context.Context) {
	service := bookeventsrepo.NewService(bookrepo.NewRepository(database))
