...
import (
	...
	mapvariablesrepo "github.com/SShlykov/zeitment/bookback/internal/domain/services/mapvariables"
...
func SetMapVariablesController(e *echo.Echo, database postgres.Client, metrics metrics.Metrics, logger *slog.Logger, ctx context.Context) {
	service := mapvariablesrepo.NewService(bookrepo.NewRepository(database))
