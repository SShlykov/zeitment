...
// @success 200 {object} entity.MapVariable
...
// @produce application/json
// @param id path string true "ID переменной карты"
// @param variable body entity.MapVariable true "MapVariable object"
// @success 200 {object} entity.MapVariable
...
// @success 200 {array} entity.MapVariable
// @failure 404 {object} config.HTTPError
...
// @produce application/json
// @param variable body entity.MapVariable true "MapVariable object"
// @success 201 {object} entity.MapVariable
// @failure 400 {object} config.HTTPError
